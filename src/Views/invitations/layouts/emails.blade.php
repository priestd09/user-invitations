                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background: #fff; border: 1px solid #e9e9e9; border-radius: 3px;" >
                    ...
                    <tr>
                        <td style="padding: 10px !important;"  colspan="2">
                            {{ trans('userinvitations.email.hi') }} <strong>{{ ucfirst($user['name'] . '  ' . $user['last_name']) }}!</strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px !important;"  colspan="2">
                    ...
                    <tr>
                        <td style="padding: 10px !important;"  colspan="2">{{ trans('userinvitations.email.body') }}</td>
                    </tr>
                </table>
                        ...
                        <table width="100%">
                            <tr>
                                <td style="text-align: center; padding: 0 0 20px;" >
                                    {{ trans('userinvitations.email.sent_to') }}&nbsp;<a href="mailto:{{ $user['email'] }}" style="color: #999; font-size: 11px" >{{ $user['email'] }}</a>
                                </td>
                            </tr>
                        </table>
